...
> [!NOTE]
> In order to give a better insight and focus on microservices archittecture, some features e.g. database, services, validation are skipped in this application and in-memory data is used.
